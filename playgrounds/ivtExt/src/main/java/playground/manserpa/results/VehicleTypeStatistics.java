...
public class VehicleTypeStatistics {
	public static void main(String[] args) throws IOException {
		...
		for(int simulationRun = 7; simulationRun <= 10; simulationRun++)	{
		    ...
		    String csvFileOccupancy = "VehicleTypeStats" + simulationRun + ".csv";
		    ...
		    if(args[0] != null)	{
		        try (BufferedReader br = new BufferedReader(new FileReader("Run" + simulationRun + args[0]))) {
		        	int k = 0;
			...
			try {
				...
				saxParser.parse("Run" + simulationRun + args[1], handler);
